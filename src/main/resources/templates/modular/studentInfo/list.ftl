                        ...
                        <div class="ibox-content">
                            <div class="bar search-bar">
                                <div class="form-inline">
                                    ...
                                    <button class="btn btn-primary"onclick="StudentInfo.search();">搜索</button>
                                    <button class="btn btn-primary"onclick="StudentInfo.reset();">重置</button>
                                    <button class="btn btn-success"onclick="StudentInfo.downloadExcel();">下载信息</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script src="/static/modular/studentInfo/studentInfo.js"></script>
</body>
</html>
